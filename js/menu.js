...
// Selecionando o botão do menu pelo seu ID, utilizando 'const' para não modificar posteriormente
...
function toggleMenu(event) {
    // Evita o comportamento padrão do evento touchstart, evitando bugs em dispositivos móveis
